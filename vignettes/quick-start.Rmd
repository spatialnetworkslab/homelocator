...
## Download homelocator source-code 

Download `homelocator` source-code from [_Figshare_](https://figshare.com/s/ce7b8bcfd2e6b44a5568)

- A walkthrough demo video can be found in `homelocator-source-code/homelocator-package/demo.mov`
- A static website of `homelocator` package can be found in `homelocator-source-code/homelocator-package/static-website`. 

## Install package 

Install the released version of `homelocator` as follows, where the **homelocator_0.1.0.tar.gz** is stored under `homelocator-source-code/homelocator-package/`. 
