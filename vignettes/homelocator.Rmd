...
The `spread_nested()` function in `spread.R` script works in the same way as [spread](https://www.rdocumentation.org/packages/tidyr/versions/0.8.3/topics/spread) function in [tidyverse](https://github.com/tidyverse/tidyverse) but works inside a nested data frame. It allows to spread a key-value pairs across multiple columns.
...
The `arrange_nested()` function in `spread.R` script works in the same way as [arrange](https://www.rdocumentation.org/packages/dplyr/versions/0.7.8/topics/arrange) function in [tidyverse](https://github.com/tidyverse/tidyverse) but works inside a nested data frame. It allows to sort rows by variables. 
...
To use the embedded recipes to identify the home location for users, you can use `identify_location()` function in `identify_location.R` script. 
