...
bots <- regular_cells %>% 
  group_by(u_id) %>% 
  summarise(count = n()) %>% 
  filter(count > 5000)   ##check users that has more than 5000 tweets 
...
uncertain_bots <- c("16264556","26790952","29145089","30894293","34748983","36498067","50685688","61536577","84020475","99353885","138271743","147287273","160390792","174782657","185370576","230799648","259550589","270164716","297144273","304403844","312988287","321823108","325230775","325877236","349345240","353333411","368368977","378323603","393736478","398344465","476940916","711882464") # those users has low probability of bot return from the app 
unknown <- c("45406258", "287966483","289054915","318647970", "404843921","497192859", "612908575") # those users cannot be found in the app, so need to look into by person
# after these, we can remove thoses potential bots (dirty data) from the dataset

# remove tweeter bot (too high)
df_step2 <- df_step2 %>% filter(!u_id %in% potential_bots) # after step 2, there are 16604 users remained. 
```
